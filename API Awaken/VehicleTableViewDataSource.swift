...
class VehicleTableViewDataSource: NSObject, EntityTableViewDataSource, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if indexPath.row == VehicleRow.cost && Int(vehicle.cost) != nil {
            ...
            cell.galacticCreditsButton.isSelected = true
            cell.galacticCreditsButton.addTarget(cell, action: #selector(CurrencyCell.convertToGalacticCredits), for: .touchUpInside)
            ...
            cell.englishButton.addTarget(cell, action: #selector(LengthCell.convertToEnglish), for: .touchUpInside)
